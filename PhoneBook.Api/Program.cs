...
app.MapPost("/api/phonebooks", async (DTOs.CreatePhoneBookRequest requestModel, IMediator mediator) =>
{
...
app.MapPost("/api/phonebooks/{phoneBookId:guid}/entries",
            async (Guid phoneBookId, DTOs.AddEntryRequest requestModel, IMediator mediator) =>
            {
